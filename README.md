...
```bash
curl -LO https://github.com/gstrainovic/zid/releases/latest/download/zid-0.1.7-x86_64-linux.tar.xz
tar xf zid-0.1.7-x86_64-linux.tar.xz
cd zid-0.1.7-x86_64-linux
...
`curl -LO https://github.com/gstrainovic/zid/releases/latest/download/zid_0.1.7-1_amd64.deb && sudo apt install ./zid_0.1.7-1_amd64.deb`.
...
```bash
sudo zypper install https://github.com/gstrainovic/zid/releases/latest/download/zid-0.1.7-1.x86_64.rpm
```

## Installation (Windows)

Am Release hängt `zid-0.1.7-x86_64-windows.zip` (gebaut von GitHub Actions).
...
committet, taggt `v0.1.7` und pusht. Der Text geht englisch
