...
```bash
curl -LO https://github.com/gstrainovic/zid/releases/latest/download/zid-0.1.5-x86_64-linux.tar.xz
tar xf zid-0.1.5-x86_64-linux.tar.xz
cd zid-0.1.5-x86_64-linux
...
```bash
sudo zypper install https://github.com/gstrainovic/zid/releases/latest/download/zid-0.1.5-1.x86_64.rpm
```
...
Am Release hängt `zid-0.1.5-x86_64-windows.zip` (gebaut von GitHub Actions).
...
committet, taggt `v0.1.5` und pusht. Der Text geht englisch
